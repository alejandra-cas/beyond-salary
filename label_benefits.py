...
parental_leave = "parental leave", "family support", "flexible maternity leave", "paternity leave", "maternity leave", "paid family leave", "paid caregiver/parental", "paid parental", "paid new parent leave"
culture = "diversity and inclusion", "team culture", "creative freedom", "values-driven", "inclusive culture", "diverse team", "inclusive environment", "value diversity"
...
check_benefits(even_sample, edu_assistance, 'EDU_ASSISTANCE', exclusions=career_dev_to_exclude)
...
check_benefits(even_sample, culture, 'CULTURE', culture_to_exclude)

print(even_sample.head())

even_sample.to_parquet('data/salary_sample_body_benefits_v3.parquet.gzip', compression='gzip')
