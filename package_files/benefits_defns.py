...
benefits4 = ['EDU_ASSISTANCE','PAID_LEAVE','HEALTH_WELLBEING', 'PARENTAL_LEAVE', 'CULTURE', 'wfh_wham', 'REMOTE_KW']
benefits_labels_map = {'EDU_ASSISTANCE': 'Tuition Assistance', 'PAID_LEAVE': 'Paid Leave', 'HEALTH_WELLBEING': 'Health and Wellbeing', 'PARENTAL_LEAVE': 'Parental Leave', 'CULTURE': 'Workplace Culture', 'wfh_wham': 'Remote Work', 'REMOTE_KW': 'Remote Keywords'}
benefits4_labels = ['Tuition Assistance', 'Paid Leave', 'Health and Wellbeing', 'Parental Leave', 'Workplace Culture', 'Remote Work', 'Remote Keywords']
