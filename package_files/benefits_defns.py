...
benefits4 = ['EDU_ASSISTANCE', 'WLB', 'PAID_LEAVE','HEALTH_WELLBEING', 'PARENTAL_LEAVE', 'CULTURE', 'wfh_wham']
benefits_labels_map = {'EDU_ASSISTANCE': 'Tuition Assistance', 'WLB': 'Work-Life Balance', 'PAID_LEAVE': 'Paid Leave', 'HEALTH_WELLBEING': 'Health and Wellbeing', 'PARENTAL_LEAVE': 'Parental Leave', 'CULTURE': 'Workplace Culture', 'wfh_wham': 'Remote Work'}
benefits4_labels = ['Tuition Assistance', 'Work-Life Balance', 'Paid Leave', 'Health and Wellbeing', 'Parental Leave', 'Workplace Culture', 'Remote Work']
