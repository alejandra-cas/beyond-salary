import pandas as pd
all_data = pd.read_parquet('data/us_10m_nointernship_ai_skills_body.parquet.gzip')
...
salary_sample_all.to_parquet('data/small_samples/salary_sample_2018_2023.parquet.gzip', compression='gzip')
...
salary_sample_all.to_parquet('data/small_samples/salary_wham_sample_20k.parquet.gzip', compression='gzip')
...
all_data_sample_all.to_parquet('data/small_samples/nosalary_sample_20k.parquet.gzip', compression='gzip')
